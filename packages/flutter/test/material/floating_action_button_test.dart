...
void main() {
  ...
  group('Compare FAB', () {
    ...
    testWidgetsWithLeakTracking('FloatingActionButton draws correct color', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
    ...
    testWidgetsWithLeakTracking('FloatingActionButtonOld draws correct color', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: material2Theme,
  ...
  testWidgets('Floating Action Button golden test m3', (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MaterialApp(
        theme: material3Theme,
    ...
    await expectLater(
      find.byKey(key),
      matchesGoldenFile('floating_action_button_test_m3.plain.png'),
    );
  });

  testWidgets('Floating Action Button golden test m2', (WidgetTester tester) async {
    final GlobalKey key = GlobalKey();
    await tester.pumpWidget(
      MaterialApp(
        theme: material2Theme,
    ...
    await expectLater(
      find.byKey(key),
      matchesGoldenFile('floating_action_button_test_m2.plain.png'),
    );
  });
