...
void main() {
  ...
  testWidgets('ThemeData.copyWith correctly creates new ThemeData with all copied arguments', (WidgetTester tester) async {
    ...
    final ThemeData theme = ThemeData.raw(
      ...
      menuBarTheme: MenuBarThemeData(backgroundColor: MaterialStateProperty.all(Colors.black)),
      chipTheme: chipTheme,
    ...
    final ThemeData otherTheme = ThemeData.raw(
      ...
      menuBarTheme: MenuBarThemeData(backgroundColor: MaterialStateProperty.all(Colors.white)),
