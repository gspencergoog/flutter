...
class IdeConfigCommand extends FlutterCommand {
  ...
  IdeType _ideTypeFromName(String name) {
    switch (name) {
      case 'intellij':
      ...
      default:
        throwToolExit('Unknown IDE type $name.\n$usage', exitCode: 2);
        break;
    }
    return null;
  }
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    for (final String ideName in stringsArg('ide')) {
      final IdeType type = _ideTypeFromName(ideName);
      final String templateDirName = ideName;
